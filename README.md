...
│   ├── digital_oracle_model.pkl    # Random Forest classifier
│   ├── le.pkl                      # Label encoder
│   └── model_columns.pkl           # Feature columns for alignment
│
├── data/                           # Dataset
│   ├── Health_Risk_Dataset.csv     # Patient vital signs data
...
│   └── 04_monte_carlo_validation.ipynb
│
...
│   ├── interventions.py            # Intervention simulation logic
│   ├── visualization.py            # Plotting and visualization
│   └── clinical_scoring.py         # NEWS2 calculation
│
├── tests/                          # Unit tests
│   ├── test_model.py
│   ├── test_monte_carlo.py
...
│   ├── generate_report.py          # Model performance report
│   └── export_results.py           # Export predictions to CSV
│
├── docs/                           # Documentation
│   ├── clinical_validation.md      # Clinical validation methodology
│   ├── ethical_considerations.md   # AI ethics framework
